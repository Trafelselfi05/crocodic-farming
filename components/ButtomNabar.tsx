...
export default function BottomNavbar() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 w-full max-w-[402px] h-[101px] mx-auto"
      role="navigation"
      aria-label="Main navigation"
    >
      {/* Background SVG */}
      <svg
        className="absolute w-full h-[71.29%] top-[28.71%] left-0"
        viewBox="0 0 402 72"
        fill="none"
      ...
      <Link
        href="/"
        className="w-[14.43%] h-[57.43%] left-[7.71%] absolute top-0"
        aria-label="Beranda"
      ...
      <span
        className={`absolute w-[15.17%] h-[20.79%] top-[70.30%] left-[7.46%] flex items-center justify-center font-['Poppins',Helvetica] font-medium text-sm text-center tracking-[0] leading-[normal] ${
          pathname === "/" ? "text-hijau-tua" : "text-abu-abu"
        }`}
      >
        Beranda
      </span>
      ...
      <Link
        href="/statistik"
        className="w-[14.68%] h-[48.51%] top-[42.57%] left-[31.34%] absolute"
        aria-label="Statistik"
      >
        <svg
          className="w-[32.20%] h-[38.78%] left-[32.20%] absolute top-0"
          viewBox="0 0 19 19"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            ...
            stroke={pathname === "/statistik" ? "#1F4E20" : "#9E9E9E"}
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
        ...
        <span
          className={`absolute w-[96.61%] h-[42.86%] top-[57.14%] left-0 flex items-center justify-center font-['Poppins',Helvetica] font-medium text-sm text-center tracking-[0] leading-[normal] ${
            pathname === "/statistik" ? "text-hijau-tua" : "text-abu-abu"
          }`}
        >
          Statistik
        </span>
      ...
      <Link
        href="/lahan"
        className="w-[11.44%] h-[50.50%] top-[40.59%] left-[56.22%] absolute"
        aria-label="Lahan"
      >
        <svg
          className="w-[52.17%] h-[47.06%] left-[23.91%] absolute top-0"
          viewBox="0 0 24 24"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            d="M3 3H10V10H3V3Z"
            stroke={pathname === "/lahan" ? "#1F4E20" : "#9E9E9E"}
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
        ...
        <span
          className={`absolute w-[95.65%] h-[41.18%] top-[58.82%] left-0 flex items-center justify-center font-poppins-medium-14 font-[number:var(--poppins-medium-14-font-weight)] text-[length:var(--poppins-medium-14-font-size)] text-center tracking-[var(--poppins-medium-14-letter-spacing)] leading-[var(--poppins-medium-14-line-height)] [font-style:var(--poppins-medium-14-font-style)] ${
            pathname === "/lahan" ? "text-hijau-tua" : "text-abu-abu"
          }`}
        >
          Lahan
        </span>
      ...
      <Link
        href="/setelan"
        className="w-[13.93%] h-[50.50%] top-[40.59%] left-[78.36%] absolute"
        aria-label="Setelan"
      >
        <span
          className={`absolute w-[96.43%] h-[41.18%] top-[58.82%] left-0 flex items-center justify-center font-poppins-medium-14 font-[number:var(--poppins-medium-14-font-weight)] text-[length:var(--poppins-medium-14-font-size)] text-center tracking-[var(--poppins-medium-14-letter-spacing)] leading-[var(--poppins-medium-14-line-height)] [font-style:var(--poppins-medium-14-font-style)] ${
            pathname === "/setelan" ? "text-hijau-tua" : "text-abu-abu"
          }`}
        >
          Setelan
        </span>
        <svg
          className="w-[42.86%] h-[47.06%] left-[28.57%] absolute top-0"
          viewBox="0 0 24 24"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle
            ...
            cy="12"
            r="3"
            stroke={pathname === "/setelan" ? "#1F4E20" : "#9E9E9E"}
            strokeWidth="2"
          />
          <path
